    ...
    <div className='flex flex-col bg-bg'>
      ...
      <div className="relative inline-flex flex-col justify-start items-center gap-2.5">
        ...
        <div className="py-32 flex flex-col justify-start items-center gap-2.5">
          <div className="justify-start"><span className="text-white text-8xl font-bold font-['Playfair_Display']">New era of </span><span className="text-primary text-8xl font-bold font-['Playfair_Display'] px-8">AI</span><span className="text-white text-8xl font-bold font-['Playfair_Display']"> </span></div>
          <div className="justify-start"><span className="text-zinc-400 text-5xl font-bold font-['Inter']">Create images </span><span className="text-triadic1 text-5xl font-bold font-['Inter'] px-4">easier</span><span className="text-zinc-400 text-5xl font-bold font-['Inter']"> than before  </span></div>
        </div>
